...
function Navbar() {
  return (
    <nav className="w-full flex justify-center items-center gap-8 py-4 mb-8 bg-zinc-200 dark:bg-zinc-900 text-center mx-auto shadow-sm">
      ...
      <Link href="/references" className="text-lg font-semibold text-blue-700 dark:text-blue-300 px-3 py-1 rounded hover:bg-blue-100 dark:hover:bg-blue-900 hover:underline transition-colors">Références</Link>
      <Link href="/citations" className="text-lg font-semibold text-blue-700 dark:text-blue-300 px-3 py-1 rounded hover:bg-blue-100 dark:hover:bg-blue-900 hover:underline transition-colors">Citations</Link>
    </nav>
  );
}
